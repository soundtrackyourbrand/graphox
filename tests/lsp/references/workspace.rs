...
async fn test_references_transitive_fragments() {
    ...
    // Fragment with variable definition
    let frag_text = "fragment UserFrag on User($id: ID!) { id }";
