...
use graphql_features::call_hierarchy::DocumentCallHierarchy;
use graphql_features::code_actions::DocumentCodeActions;
use graphql_features::completion::{DocumentCompletion, FragmentCompletionInfo};
use graphql_features::definition::DocumentDefinition;
use graphql_features::document_highlight::DocumentHighlightFeature;
use graphql_features::folding_range::DocumentFoldingRange;
use graphql_features::hover::DocumentHover;
use graphql_features::references::DocumentReferences;
use graphql_features::selection_range::DocumentSelectionRange;
use graphql_features::semantic_tokens::DocumentSemanticTokens;
...
pub struct Backend {
    ...
    pub type_caches: Arc<DashMap<String, Arc<graphql_codegen::TypeCache>, ahash::RandomState>>,
...
impl Backend {
    pub fn new(client: Client, mut config: Config) -> Self {
        ...
        let gitignore = Arc::new(graphql_core::utils::get_gitignore_matcher(&config.base_dir));
    ...
    fn load_schema_source(
        ...
        graphql_core::schema::load_schema_arc(base_dir, source)
    }
...
mod tests {
    use super::*;
    use graphql_core::config::{GlobPattern as GqlGlobPattern, ProjectConfig, SchemaSource};
