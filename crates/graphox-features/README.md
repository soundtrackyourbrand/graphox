...
This crate uses extension traits to add LSP features to `DocumentState` (defined in `graphox-core`). This decoupling allows the core models to remain lean and makes it easier to test individual features.
