...
The Language Server Protocol (LSP) implementation for `Graphox`.

## Architecture

Built on top of `tower-lsp`, this crate implements the `LanguageServer` trait and integrates the features provided by `graphox-features`.
